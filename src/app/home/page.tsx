...
export default function HomePage() {
  ...
  console.log('HomePage - Should show admin?', user?.role === 'admin');
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4">
      <div className="max-w-5xl w-full space-y-8">
        ...
        <div className={`grid grid-cols-1 ${user?.role === 'admin' ? 'md:grid-cols-2' : ''} gap-6 mt-12 ${user?.role === 'driver' ? 'max-w-md mx-auto' : ''}`}>
          <Link
            href="/driver"
